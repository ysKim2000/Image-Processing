...
cv2.imwrite('Test_Code/1.jpg', cv2.resize(img, (500,500)))
cv2.imwrite('Test_Code/2.jpg', cv2.resize(tophat_result, (500,500)))
cv2.imwrite('Test_Code/3.jpg', cv2.resize(blackhat_result, (500,500)))
